...
set "PYTHON_EXE="
set "LOG_DIR=%~dp0logs"
set "LOG_FILE=%LOG_DIR%\paid_subscriptions.log"
set "LAST_RUN_LOG=%LOG_DIR%\paid_subscriptions_last.log"
...
echo ==============================================
echo Ejecutando reactivacion de suscripciones por pago
echo Log: %LOG_FILE%
echo ==============================================
...
call "%PYTHON_EXE%" -m flask --app flaskr check-paid-subscriptions > "%LAST_RUN_LOG%" 2>&1
